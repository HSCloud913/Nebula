...
namespace ne::io
{
	...
	ne::Task<IoResult<std::size_t>> File::Readv(const ne::memory::BufferChain& _chain, const ulonglong_t _offset, std::stop_token _stopToken)
	{
	...
	ne::Task<IoResult<std::size_t>> File::Writev(const ne::memory::BufferChain& _chain, const ulonglong_t _offset, std::stop_token _stopToken)
	{
