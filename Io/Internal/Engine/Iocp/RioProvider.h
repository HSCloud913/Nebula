...
namespace ne::io
{
	...
	private:
		 ...
		 */
		[[nodiscard]] IoResult<void_t> EnsureInitialized() noexcept;
		 ...
		 */
		[[nodiscard]] IoResult<RIO_RQ> EnsureRequestQueueLocked(socket_t _socket) noexcept;
		 ...
		 */
		[[nodiscard]] IoResult<void_t> Submit(socket_t _socket, BufferHandle _handle, const void_t* _buffer, std::size_t _length, void_t* _userData, bool_t _isSend) noexcept;
	...
	public:
		 ...
		 */
		[[nodiscard]] IoResult<void_t> ArmNotify() noexcept;
