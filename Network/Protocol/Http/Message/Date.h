...
namespace ne::network::http
{
	 ...
	 */
	[[nodiscard]] string_t FormatDate(std::chrono::system_clock::time_point _timePoint);
	 ...
	 */
	[[nodiscard]] std::optional<std::chrono::system_clock::time_point> ParseDate(string_view_t _text);
}
