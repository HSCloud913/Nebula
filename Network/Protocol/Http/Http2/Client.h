...
public:
	[[nodiscard]] static ne::Task<ne::Result<Http2Client, ne::HttpError>> Connect(std::unique_ptr<ne::network::IStream> _stream);

	[[nodiscard]] ne::Task<ne::Result<ne::network::HttpResponse, ne::HttpError>> Request(const ne::network::HttpRequest& _req);
