...
{
	auto result = crypto::HashFactory::Create(crypto::HashType::CRC32)->GetHashFromString("nebula_crypto_test");
...
{
	auto result = crypto::HashFactory::Create(crypto::HashType::CRC32)->GetHashFromFile(R"(E:\_PROJECT\_LIB\Nebula\_bin\test\Nebula hash test.txt)");
...
{
	auto result = crypto::HashFactory::Create(crypto::HashType::MD5)->GetHashFromString("nebula_crypto_test");
...
{
	auto result = crypto::HashFactory::Create(crypto::HashType::MD5)->GetHashFromFile(R"(E:\_PROJECT\_LIB\Nebula\_bin\test\Nebula hash test.txt)");
...
{
	auto result = crypto::HashFactory::Create(crypto::HashType::SHA1)->GetHashFromString("nebula_crypto_test");
...
{
	auto result = crypto::HashFactory::Create(crypto::HashType::SHA1)->GetHashFromFile(R"(E:\_PROJECT\_LIB\Nebula\_bin\test\Nebula hash test.txt)");
...
{
	auto result = crypto::HashFactory::Create(crypto::HashType::SHA2_224)->GetHashFromString("nebula_crypto_test");
	EXPECT_EQ(result, "42b23380642dca8c745a7fefee33401b9a5f88282e74abc7779315a2");

	result = crypto::HashFactory::Create(crypto::HashType::SHA2_256)->GetHashFromString("nebula_crypto_test");
	EXPECT_EQ(result, "57e8c9b95dae156a76f6749d8ae381a7dedd00e36c4bab305d7fc96b08a1cafd");

	result = crypto::HashFactory::Create(crypto::HashType::SHA2_384)->GetHashFromString("nebula_crypto_test");
	EXPECT_EQ(result, "f92d240bcfa2e062246160716ef3c44d4619e02a035108534ae404da4b3c89411e1122afbf3320236cd0d42bc351ba98");

	result = crypto::HashFactory::Create(crypto::HashType::SHA2_512)->GetHashFromString("nebula_crypto_test");
...
{
	auto result = crypto::HashFactory::Create(crypto::HashType::SHA2_224)->GetHashFromFile(R"(E:\_PROJECT\_LIB\Nebula\_bin\test\Nebula hash test.txt)");
	EXPECT_EQ(result, "cc3394f255e4800e1ab2766871390aa9007c6ba45a0ddbdf813b6c35");

	result = crypto::HashFactory::Create(crypto::HashType::SHA2_256)->GetHashFromFile(R"(E:\_PROJECT\_LIB\Nebula\_bin\test\Nebula hash test.txt)");
	EXPECT_EQ(result, "39f7a637bbed6db0c0db3914fd2d0521c9d3edde5b4f698ffb4872ce0c925377");

	result = crypto::HashFactory::Create(crypto::HashType::SHA2_384)->GetHashFromFile(R"(E:\_PROJECT\_LIB\Nebula\_bin\test\Nebula hash test.txt)");
	EXPECT_EQ(result, "e4f194aec15e2dee857fd847cd946336e623aef53bdcb6033aae7d2cdf29e1d8c4b928601ec57d45cea5666e68198cd1");

	result = crypto::HashFactory::Create(crypto::HashType::SHA2_512)->GetHashFromFile(R"(E:\_PROJECT\_LIB\Nebula\_bin\test\Nebula hash test.txt)");
...
{
	auto result = crypto::HashFactory::Create(crypto::HashType::SHA3_224)->GetHashFromString("nebula_crypto_test");
	EXPECT_EQ(result, "d48305ca85f518bed9fe6dedb66c4f30cf1969fe9fba4d412d2e93c9");

	result = crypto::HashFactory::Create(crypto::HashType::SHA3_256)->GetHashFromString("nebula_crypto_test");
	EXPECT_EQ(result, "d79a9c8f568cdd7fcf062793dd894f957d11009050606907ea008518199bca7f");

	result = crypto::HashFactory::Create(crypto::HashType::SHA3_384)->GetHashFromString("nebula_crypto_test");
	EXPECT_EQ(result, "2d3fc82307d901de619b10957f0c906a05c60e3e822b97f9347e79ea6b9125d0c1fe22f6ea57a009f89b92b9a2d9c60e");

	result = crypto::HashFactory::Create(crypto::HashType::SHA3_512)->GetHashFromString("nebula_crypto_test");
...
{
	auto result = crypto::HashFactory::Create(crypto::HashType::SHA3_224)->GetHashFromFile(R"(E:\_PROJECT\_LIB\Nebula\_bin\test\Nebula hash test.txt)");
	EXPECT_EQ(result, "6ef7cd5b40a10e4db064745cefea4e634f92d8703052a83fe57db2d1");

	result = crypto::HashFactory::Create(crypto::HashType::SHA3_256)->GetHashFromFile(R"(E:\_PROJECT\_LIB\Nebula\_bin\test\Nebula hash test.txt)");
	EXPECT_EQ(result, "9eb633197ac9ac9946421ef0c662c4f7e57967021aa2b57401ab0763745d5fe0");

	result = crypto::HashFactory::Create(crypto::HashType::SHA3_384)->GetHashFromFile(R"(E:\_PROJECT\_LIB\Nebula\_bin\test\Nebula hash test.txt)");
	EXPECT_EQ(result, "0bcca95fe73112184d56abce905b12d4dbcd9f6323eb060b9b695d1a143c4aa1e94aa8aae996ad2156b691a76b01740d");

	result = crypto::HashFactory::Create(crypto::HashType::SHA3_512)->GetHashFromFile(R"(E:\_PROJECT\_LIB\Nebula\_bin\test\Nebula hash test.txt)");
...
TEST(HashTest, HmacMd5)
{
	...
	auto result = crypto::HMAC::Compute(crypto::HashType::MD5, "Jefe", "what do ya want for nothing?");
...
{
	// RFC 2202 Test Case 2: key="Jefe", data="what do ya want for nothing?"
	auto result = crypto::HMAC::Compute(crypto::HashType::SHA1, "Jefe", "what do ya want for nothing?");
...
TEST(HashTest, HmacSha256)
{
	...
	auto result = crypto::HMAC::Compute(crypto::HashType::SHA2_256, "Jefe", "what do ya want for nothing?");
...
{
	// RFC 4231 Test Case 2: key="Jefe", data="what do ya want for nothing?"
	auto result = crypto::HMAC::Compute(crypto::HashType::SHA2_512, "Jefe", "what do ya want for nothing?");
