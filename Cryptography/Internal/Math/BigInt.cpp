...
namespace ne::crypto::internal
{
	...
	BigInt BigInt::Random(const size_t _bits, ne::util::SecureRandom& _rng)
	{
	...
	BigInt BigInt::RandomPrime(const size_t _bits, ne::util::SecureRandom& _rng)
	{
		while (true)
		{
